...
describe('PromptManager', () => {
  ...
  describe('register()', () => {
    ...
    it('should override existing prompt when allowed', () => {
      ...
      const prompt2 = { ...createPrompt('test-prompt'), description: 'Updated description' };
  ...
  describe('registerMany()', () => {
    it('should register multiple prompts at once', () => {
      const prompts = [createPrompt('prompt-1'), createPrompt('prompt-2'), createPrompt('prompt-3')];
  ...
  describe('getPrompt()', () => {
    ...
    it('should throw PromptNotFoundError for non-existent prompt', () => {
      expect(() => manager.getPrompt('non-existent')).toThrow(PromptNotFoundError);
    });
