...
describe('PromptValidator', () => {
  describe('validate()', () => {
    ...
    it('should throw PromptValidationError for invalid prompt', () => {
      ...
      expect(() => PromptValidator.validate(prompt, 'test.md')).toThrow(PromptValidationError);
    });
    ...
    it('should include file path and errors in validation error', () => {
      ...
      try {
        ...
        expect(validationError.errors).toContain('Prompt name cannot be empty or whitespace only');
        expect(validationError.errors).toContain('Prompt description cannot be empty or whitespace only');
      }
    });
  });
  ...
  describe('name validation', () => {
    it('should reject missing name', () => {
      ...
      const result = PromptValidator.validatePrompt(prompt);
      expect(result.valid).toBe(false);
      expect(result.errors).toContain('Prompt name cannot be empty or whitespace only');
    });
    ...
    it('should reject name longer than 100 characters', () => {
      ...
      const result = PromptValidator.validatePrompt(prompt);
      expect(result.valid).toBe(false);
      expect(result.errors).toContain('Prompt name must be 100 characters or less');
    });
  ...
  describe('description validation', () => {
    it('should reject missing description', () => {
      ...
      const result = PromptValidator.validatePrompt(prompt);
      expect(result.valid).toBe(false);
      expect(result.errors).toContain('Prompt description cannot be empty or whitespace only');
    });
    ...
    it('should reject description longer than 500 characters', () => {
      ...
      const result = PromptValidator.validatePrompt(prompt);
      expect(result.valid).toBe(false);
      expect(result.errors).toContain('Prompt description must be 500 characters or less');
    });
  ...
  describe('tags validation', () => {
    ...
    it('should reject empty string tags', () => {
      ...
      const result = PromptValidator.validatePrompt(prompt);
      expect(result.valid).toBe(false);
      expect(result.errors).toContain('Tags cannot be empty or whitespace only');
    });
    ...
    it('should reject tags longer than 50 characters', () => {
      ...
      const result = PromptValidator.validatePrompt(prompt);
      expect(result.valid).toBe(false);
      expect(result.errors.some((e) => e.includes('must be 50 characters or less'))).toBe(true);
    });
  ...
  describe('arguments validation', () => {
    ...
    it('should reject argument without name', () => {
      ...
      const result = PromptValidator.validatePrompt(prompt);
      expect(result.valid).toBe(false);
      expect(result.errors).toContain('Argument name is required and must be a string');
    });
    ...
    it('should reject argument with empty name', () => {
      ...
      const result = PromptValidator.validatePrompt(prompt);
      expect(result.valid).toBe(false);
      expect(result.errors).toContain('Argument name cannot be empty or whitespace only');
    });
    ...
    it('should reject argument without description', () => {
      ...
      const result = PromptValidator.validatePrompt(prompt);
      expect(result.valid).toBe(false);
      expect(result.errors.some((e) => e.includes('Argument description is required'))).toBe(true);
    });
    ...
    it('should reject argument with empty description', () => {
      ...
      const result = PromptValidator.validatePrompt(prompt);
      expect(result.valid).toBe(false);
      expect(result.errors).toContain('Argument description cannot be empty for argument: arg1');
    });
    ...
    it('should reject argument with description longer than 200 characters', () => {
      ...
      const result = PromptValidator.validatePrompt(prompt);
      expect(result.valid).toBe(false);
      expect(result.errors.some((e) => e.includes('must be 200 characters or less'))).toBe(true);
    });
    ...
    it('should reject argument with non-boolean required field', () => {
      ...
      const result = PromptValidator.validatePrompt(prompt);
      expect(result.valid).toBe(false);
      expect(result.errors).toContain("Argument 'required' field must be a boolean for argument: arg1");
    });
